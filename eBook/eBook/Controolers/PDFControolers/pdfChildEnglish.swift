...
class pdfChildEnglish: UIViewController, PDFViewDelegate {
    
    var oldTabbarFr: CGRect = .zero
    var opendEngilahBook: String?
    ...
    override func viewDidLoad() {
       ...
       // add pdfView to viewController
        ...
        guard let path = Bundle.main.url(forResource: opendEngilahBook, withExtension: "pdf") else {
