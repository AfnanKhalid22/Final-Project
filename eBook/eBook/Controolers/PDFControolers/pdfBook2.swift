...
//  eBook
//
//  Created by Fno Khalid on 23/04/1443 AH.
//

import UIKit
import PDFKit

class pdfBook2: UIViewController, PDFViewDelegate {
    
    var oldTabbarFr: CGRect = .zero
    var openedEBook: String?
    ...
    override func viewDidLoad() {
       ...
       // add pdfView to viewController
        ...
        guard let path = Bundle.main.url(forResource: openedEBook, withExtension: "pdf") else {
